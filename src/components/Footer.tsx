...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Orilis", path: "/about" },
    { label: "Benefits of REACH Orilis", path: "/benefits" },
    // { label: "Learning Guides", path: "/learningguide" },
    // { label: "Presentations", path: "/presentations" },
    // { label: "REACH Bags Nester Images", path: "/rmmimages" },
          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                <img src={emailIcon} alt="Email contact for REACH Tech" className="w-8 icon-a52356" />
              ...
              >
                <img src={whatsappIcon} alt="Whatsapp contact for REACH Tech" className="w-8 icon-a52356" />
                <span className="text-gray-300 text-lg">
                  +91 84592 78496
                </span>
              </a>
              ...
              >
                <img src={contactIcon} alt="Contact form link for REACH Tech" className="w-7 icon-a52356" />
                <span className="text-gray-300 text-lg">
                  Write to Us
                </span>
              </a>
